        ...
        <script>
            ...
            function changeFunc() {
                ...
                if(urlParams.get('search')){
                    window.location.href= "/gest_prodotti?page=1&search="+urlParams.get('search')+"&perPage="+selectedValue;  
                }else{
                    window.location.href= "/gest_prodotti?page=1&perPage="+selectedValue;  
                }
    ...
    <body class="antialiased">
            ...
            <div class = "row">
                <div class="selectPagination col-sm">
                    ...
                    <select name="pageNumber" id="pageNumber" class="form-select" onchange="changeFunc();">
                        @php
                            $pageOptions= [2, 5, 10, 15];
                        @endphp
                        @foreach($pageOptions as $pageOption)
                            @if($pageOption==$perPage )
                ...
                <div class="rightContent col-sm">
                    <div class="search">
                        <form action="{{route('gest_prodotti')}}">
                            <input type="text" placeholder="Cerca" name="search" class="searchInput">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i></button>
                        </form>
                    </div>
                    <a class="btn btn-primary reload" href="{{route('gest_prodotti')}}">Ricarica Pagina</a>
                ...
                <table id="dtBasicExample" class="table table-bordered table-sm"  cellspacing="0" width="100%">
                            ...
                            <th class="th-sm">
                                <div class="row">
                                    ...
                                    <div class="upAndDown col-sm-3">
                                        <a class="up" href="{{route('gest_prodotti', [
                                            'perPage'=> $perPage,
                                            'column' => $campo,
                                            'type'=> 'ASC'
                                            ])}}"><i class="fa fa-arrow-up" aria-hidden="true"></i></a>
                                        <a class="down" href="{{route('gest_prodotti', [
                                            'perPage'=> $perPage,
                                            'column' => $campo,
                                            'type'=> 'DESC'
                    ...
                    @if($products)
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('product.edit', ['id'=> $id])}}">Modifica</a></td>
